		...
		<div className='landing-page'>
			<Layout>
				...
				<Content>
						...
						<h1 className="header"> You are minutes away from saving on your Burial Insurance</h1>
                        <div className="inputField">
							
                        <div className='text'>
                                <h1 className='lPHeading text-center'>
                                Compare Multiple Burial Insurance Quotes 
                                </h1>
